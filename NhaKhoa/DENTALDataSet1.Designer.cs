...
namespace NhaKhoa.DENTALDataSet1TableAdapters {
...
SELECT DoctorID, FullName, Specialization, DateOfBirth, Gender, IdentityNumber, Address, Email, PhoneNumber, Image FROM Doctors WHERE (DoctorID = @DoctorID)";
        ...
        public virtual int Fill(DENTALDataSet1.DoctorsDataTable dataTable) {
        ...
        public virtual DENTALDataSet1.DoctorsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DENTALDataSet1.DoctorsDataTable dataTable = new DENTALDataSet1.DoctorsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DENTALDataSet1.DoctorsDataTable dataTable) {
